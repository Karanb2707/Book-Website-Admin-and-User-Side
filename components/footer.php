<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:krutika@gmail.com"><i class="fas fa-envelope"></i> krutika@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> mumbai, india - 400001 </a>
      </div>
      ...
      <div class="box">
         ...
         <a href="https://www.linkedin.com/company/login/"><i class="fab fa-linkedin"></i>linkedin</a>
      </div>

   </section>

   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Krutika Jumare</span> | all rights reserved!</div>
